...
def get_pie_chart(entered_site):
    ...
    if entered_site == 'ALL':
        ...
        filtered_df['count_outcome'] = 1
        fig = px.pie(filtered_df, values='count_outcome', 
        names='outcome', 
...
def get_scatter_chart(entered_site, payload):
    ...
    filtered_df = filtered_payload_df[
                filtered_payload_df['Launch Site']==entered_site
                ]
    if entered_site == 'ALL':
        fig = px.scatter(filtered_payload_df,x='Payload Mass (kg)',
